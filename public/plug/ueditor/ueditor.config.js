...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        // 服务器统一请求接口路径
        , serverUrl: BASEURL + ""
        , configUrl: "/plug/ueditor/ueditor.config.js"
        ...
        , toolbars: [[
        "fontfamily","fontsize","bold","italic","underline","forecolor",/*"shadowcolor",*/"backcolor","strikethrough","|","justifyleft","justifycenter","justifyright",'justifyjustify',"removeformat",'autotypeset','sensitivewords',"|"/*,'outpadding'*/,"blockquote",'uploadword',"uploadpdf","link",'unlink','date','time',/*'insertorderedlist', 'insertunorderedlist',*/"|","addpic","addvideo","map","source",
        // "removeformat",'formatmatch',"autotypeset",'blockquote','pasteplain','link','unlink','sensitivewords',"uploadword",'uploadpdf',"source",'selectall','cleardoc','searchreplace',"undo","redo","|",'touppercase','tolowercase','strikethrough','superscript','subscript','fontborder','directionalityltr','directionalityrtl','imagenone','imageleft','imageright','imagecenter',
        // 'date','time','map','emotion',"horizontal","inserttable",'deletetable','insertparagraphbeforetable','insertrow','deleterow','insertcol','deletecol','mergecells','mergedown','splittocells','splittorows','splittocols','print','help',/*'background',*//*'simpleupload',"insertimage",'music','insertvideo'*/,
        // /*,'remotecontent' 'spechars'/*,'emotion'*/,/*'directionalityltr', 'directionalityrtl','fullscreen',*/ 'message','imgstyle',
        ]]
        ...
        ,iframeCssUrl: 'plug/ueditor/themes/iframe.css' 
...
//                'cn2':'(一),(二),(三)....',
        ...
        ,shortcutMenu:["fontfamily","fontsize","|",
                       ...
                       "|","justifyleft","justifycenter","justifyright",'justifyjustify',"indent","rowspacingtop",'rowspacingbottom',"lineheight",'letterspacing','abstract']
        ...
        //清除格式时可以删除的标签和属性
        //removeForamtTags标签
        ,removeFormatTags:'a,b,big,code,del,dfn,em,font,i,section,blockquote,pre,fieldset,ins,kbd,q,samp,small,span,label,strike,strong,sub,sup,tt,u,var,table,tbody,td,tr,article'
        //removeFormatAttributes属性
        ,removeFormatAttributes:'style,lang,width,accuse,height,align,hspace,valign,data-width,data-brushtype,opacity,border,title,placeholder'
        ...
        whitListClass:['zwf','liveBox']//自动排版不需要删除的class
    };
