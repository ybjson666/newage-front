...
class TableList extends Component {
  ...
  render() {
    const { detailData = {}, serverArea = [], serverType = [], zzmm = [], jyxl = [],spiderData=[] } = this.props;
    ...
    const getSpiderName=(spiderId)=>{
      let spiderName="暂未设置";
      spiderData.map(item=>{
        if(item.userId==spiderId){
          spiderName=item.userName
        }
      })
      return spiderName;
    }
    ...
    return (
      <>
        <Breadcrumb className="breadcrumbBox">
          <Breadcrumb.Item>
            <Link onClick={this.props.onOk} to={'/ActivityCheckList'}>
              {this.props.navTitle}
            </Link>
          </Breadcrumb.Item>
          <Breadcrumb.Item>
            <Link to={'/ActivityCheckList'} className={'active'}>
              招募活动报名申请详情
            </Link>
          </Breadcrumb.Item>
        </Breadcrumb>
            ...
            <div className='part-content'>
              <div className='detail-panel-part'>
                ...
                <div className='content-part'>
                  ...
                  <div className='content-line'>
                    活动地点：{ActivityRecruit.address}
                  </div>
                  <div className='content-line'>
                    活动地区：{this.getTags(serverArea,ActivityRecruit.areaid)}
                  </div>
                  <div className='content-line'>
                    服务类型：{this.getTags(serverType,ActivityRecruit.activitytype)
                  }
                  </div>
                  <div className='content-line'>
                  ...
                  <div className='content-line'>
                    招募人数：{ActivityRecruit.hascount}/{ActivityRecruit.recruitcount==0?'无限制':ActivityRecruit.recruitcount}
                  </div>
                  <div className='content-line'>
                    活动描述：
              ...
              <div className='detail-panel-part'>
                ...
                <div className='content-part'>
                  ...
                  <div className='content-line'>
                    申请人姓名：{CustomerInfo.realname}
                  </div>
                  <div className='content-line'>
                    申请人联系电话：{CustomerInfo.contactphone}
                  </div>
                  <div className='content-line'>
                    申请人所属组织：{getSpiderName(CustomerInfo.spiderid)}
                  </div>
                  <div className='content-line'>
